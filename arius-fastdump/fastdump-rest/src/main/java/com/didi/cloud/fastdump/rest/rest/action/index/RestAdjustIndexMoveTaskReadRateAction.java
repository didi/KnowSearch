...
import com.didi.cloud.fastdump.core.action.metadata.AdjustIndexMoveTaskReadRateAction;
 ...
 */
@Component
public class RestAdjustIndexMoveTaskReadRateAction extends BaseCommonHttpAction {
    @Autowired
    private AdjustIndexMoveTaskReadRateAction adjustIndexMoveTaskReadRateAction;
    @Override
    protected void register() {
        restHandlerFactory.registerHandler(PUT, "/index-move/adjust-readRate", this);
    }

    @Override
    protected String name() { return "index-move-adjust-readRate";}
    ...
    protected void handleRequest(QueryContext queryContext, RestChannel channel) throws Exception {
        ...
        adjustIndexMoveTaskReadRateAction.doAction(readFileRateInfo);
