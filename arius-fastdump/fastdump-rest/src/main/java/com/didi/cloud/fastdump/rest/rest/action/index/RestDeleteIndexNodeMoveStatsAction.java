...
import com.didi.cloud.fastdump.core.action.metadata.DeleteIndexNodeMoveStatsAction;
 ...
 */
@Component
public class RestDeleteIndexNodeMoveStatsAction extends BaseCommonHttpAction {
    private final DeleteIndexNodeMoveStatsAction deleteIndexNodeMoveStatsAction;

    public RestDeleteIndexNodeMoveStatsAction(DeleteIndexNodeMoveStatsAction deleteIndexNodeMoveStatsAction) {
        this.deleteIndexNodeMoveStatsAction = deleteIndexNodeMoveStatsAction;
    }

    @Override
    protected void register() {
        restHandlerFactory.registerHandler(DELETE, "index-node-move/{taskId}/stats", this);
    }

    @Override
    protected String name() {
        return "delete-index-node-move-stats";
    }
    ...
    protected void handleRequest(QueryContext queryContext, RestChannel channel) throws Exception {
        ...
        deleteIndexNodeMoveStatsAction.doAction(taskId);
