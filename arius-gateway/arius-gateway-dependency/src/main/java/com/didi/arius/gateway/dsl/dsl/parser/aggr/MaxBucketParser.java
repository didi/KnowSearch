...
import com.didi.arius.gateway.dsl.dsl.ast.aggr.MaxBucket;
...
public class MaxBucketParser extends DslParser {

    public MaxBucketParser(ParserType type) {
        super(type);
    }

    @Override
    public KeyWord parse(String name, Object obj) throws Exception {
        MaxBucket node = new MaxBucket(name);
