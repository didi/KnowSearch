...
export const RegisterFrom: React.FC<any> = (props: {
  fn: (t: string) => any;
}) => {
  const [userNameCheckColorlength, setUserNameCheckColorlength] =
    React.useState("#A8ADBD");
  const [userNameCheckColorReg, setUserNameCheckColorReg] =
    React.useState("#A8ADBD");
  const [userNameCheckRepeat, setUserNameCheckRepeat] =
    React.useState("#A8ADBD");
  const [pwdCheckColorlength, setpwdCheckColorlength] =
    React.useState("#A8ADBD");
        ...
        <>
          <div>
            {userNameCheckColorlength !== "#EF645C" ? (
              <CheckCircleOutlined
                style={{ color: userNameCheckColorlength }}
              />
            ) : (
              <CloseCircleOutlined
                style={{ color: userNameCheckColorlength }}
