...
export const clusterSetting = {
  ...
  ROUTING: {
    ...
    "cluster.routing.allocation.allow_rebalance": {
      info: "指定何时允许分片重新平衡。always：一直允许重新平衡；indices_primaries_active：只有当集群中的所有的 primaries 被分配；indices_all_active：只有当集群中的所有分片（primaries and replicas）被分配（默认）",
      type: select,
