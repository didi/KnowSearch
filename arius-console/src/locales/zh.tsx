...
export const permissions = {
  ...
  [`menu.${systemKey}.cluster.gateway.detail`]: "/cluster/gateway",
};
...
export default {
  ...
  [`menu.${systemKey}.work-order.task.fastindex-detail`]: "任务详情",
  [`menu.${systemKey}.software`]: "软件管理",
  [`menu.${systemKey}.software.script-center`]: "脚本中心",
  [`menu.${systemKey}.software.software-center`]: "软件中心",
  ...
  [`menu.${systemKey}.cluster.gateway`]: "Gateway集群",
  [`menu.${systemKey}.cluster.gateway.detail`]: "Gateway集群详情",
