...
export const TASK_STATUS_NUMBER_MAP = {
  0: "waiting",
  1: "running",
  2: "failed",
  3: "pause",
...
export const FASTINDEX_STATS = [
  { type: "waiting", className: "waiting", text: "待执行" },
  { type: "running", className: "running", text: "执行中" },
  { type: "success", className: "success", text: "成功" },
  { type: "failed", className: "failed", text: "失败" },
  { type: "cancel", className: "cancel", text: "已取消" },
  { type: "unSubmit", className: "cancel", text: "未提交" },
];

export const FASTINDEX_STATUS = {
  success: { type: "success", className: "success", text: "成功" },
  waiting: { type: "waiting", className: "waiting", text: "待执行" },
  running: { type: "running", className: "running", text: "执行中" },
  failed: { type: "failed", className: "failed", text: "失败" },
  cancel: { type: "cancel", className: "cancel", text: "已取消" },
};
