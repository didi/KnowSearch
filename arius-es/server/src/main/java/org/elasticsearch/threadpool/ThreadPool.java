...
public class ThreadPool implements Scheduler {
    ...
    public static class Names {
        ...
        public static final String SEARCH_CHECKER = "search_checker";
    }
    ...
    static {
        ...
        map.put(Names.SEARCH_CHECKER, ThreadPoolType.SCALING);
    ...
    public ThreadPool(final Settings settings, final ExecutorBuilder<?>... customBuilders) {
        ...
        builders.put(Names.SEARCH_CHECKER, new ScalingExecutorBuilder(Names.SEARCH_CHECKER, 1, 2 * availableProcessors, TimeValue.timeValueMinutes(5)));
