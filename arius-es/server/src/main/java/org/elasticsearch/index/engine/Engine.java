...
public abstract class Engine implements Closeable {
    ...
    /**
     * Marks the provided sequence number as LocalCheckpointTracker and updates the checkpoint if possible.
     *
     * @param seqNo the sequence number to mark as checkpoint
     */
    public void markLocalCheckpointTrackerSeqNo(final long seqNo) {}
