...
final class Checkpoint {
    ...
    public static void write(ChannelFactory factory, Path checkpointFile, Checkpoint checkpoint, OpenOption... options) throws IOException {
        writeBySyncMode(factory, checkpointFile, checkpoint, true, options);
    }

    public static void writeBySyncMode(ChannelFactory factory, Path checkpointFile, Checkpoint checkpoint, boolean translogFSync, OpenOption... options) throws IOException {
