...
public class MapperService extends AbstractIndexComponent implements Closeable {
    ...
    private static final String[] SORTED_META_FIELDS = new String[]{
        "_uid", "_id", IgnoredFieldMapper.NAME, "_index", "_routing", "_size", "_timestamp", "_ttl", "_type"
    };
            ...
            if (documentMapper != null) {
                ...
                try {
                    DocumentMapper newDocumentMapper =
                        documentParser.parse(type, entry.getValue(), null);
                    documentMapper.merge(newDocumentMapper.mapping());
                    continue;
                } catch (Exception e) {
                    throw new MapperParsingException("Failed to parse mapping [{}]: {}", e, entry.getKey(), e.getMessage());
                }
