 ...
 */
public class SearchShardTask extends AutoCancellableTask {

    // 最大查询运行时刻
    private long maxSearchExecuteOnTime = -1L;
    ...
    public long getMaxSearchExecuteOnTime() {
        return maxSearchExecuteOnTime;
    }

    public void setMaxSearchExecuteOnTime(long maxSearchExecuteOnTime) {
        this.maxSearchExecuteOnTime = maxSearchExecuteOnTime;
    }
}
