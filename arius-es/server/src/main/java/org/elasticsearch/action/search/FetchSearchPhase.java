...
final class FetchSearchPhase extends SearchPhase {
    ...
    FetchSearchPhase(SearchPhaseResults<SearchPhaseResult> resultConsumer,
                     ...
                     SearchPhaseContext context, TransportSearchAction.SearchTimeProvider timeProvider) {
            ...
            new SearchActionListener<FetchSearchResult>(shardTarget, shardIndex) {
                ...
                public void innerOnResponse(FetchSearchResult result) {
                    try {
                        ...
                        timeProvider.putFetchCost(shardTarget.getShardId(), System.currentTimeMillis());
