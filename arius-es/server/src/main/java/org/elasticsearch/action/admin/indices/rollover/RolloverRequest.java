...
public class RolloverRequest extends AcknowledgedRequest<RolloverRequest> implements IndicesRequest, ToXContentObject {
    ...
    public RolloverRequest(StreamInput in) throws IOException {
        super(in);
        alias = in.readString();
        sourceIndexName = in.readOptionalString();
    ...
    public RolloverRequest(String alias, String sourceIndexName, String newIndexName) {
        this.alias = alias;
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        out.writeOptionalString(sourceIndexName);
