...
public class DiskThresholdSettings {
    ...
    protected volatile String lowWatermarkRaw;
    protected volatile String highWatermarkRaw;
    protected volatile Double freeDiskThresholdLow;
    protected volatile Double freeDiskThresholdHigh;
    protected volatile ByteSizeValue freeBytesThresholdLow;
    protected volatile ByteSizeValue freeBytesThresholdHigh;
    protected volatile boolean includeRelocations;
    protected volatile boolean enabled;
    protected volatile TimeValue rerouteInterval;
    protected volatile Double freeDiskThresholdFloodStage;
    protected volatile ByteSizeValue freeBytesThresholdFloodStage;
    protected static final boolean autoReleaseIndexEnabled;
    ...
    protected static void doValidateAsPercentage(final String low, final String high, final String flood) {
    ...
    protected void setIncludeRelocations(boolean includeRelocations) {
        this.includeRelocations = includeRelocations;
    }

    protected void setRerouteInterval(TimeValue rerouteInterval) {
    ...
    public Setting getLowWatermarkSetting() {
        return CLUSTER_ROUTING_ALLOCATION_LOW_DISK_WATERMARK_SETTING;
    }

    public Setting getHighWatermarkSetting() {
        return CLUSTER_ROUTING_ALLOCATION_HIGH_DISK_WATERMARK_SETTING;
    }
     ...
     * it cannot be parsed.
     */
    protected static double thresholdPercentageFromWatermark(String watermark) {
     ...
     */
    protected static ByteSizeValue thresholdBytesFromWatermark(String watermark, String settingName) {
     ...
     */
    protected static ByteSizeValue thresholdBytesFromWatermark(String watermark, String settingName, boolean lenient) {
        try {
     ...
     */
    protected static String validWatermarkSetting(String watermark, String settingName) {
        try {
