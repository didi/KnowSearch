...
public class ElasticsearchException extends RuntimeException implements ToXContentFragment, Writeable {
    ...
    private enum ElasticsearchExceptionHandle {
        ...
        TRANSLOG_OFFSET_BEHIND_EXCEPTION(TranslogOffsetBehindException.class,
            TranslogOffsetBehindException::new, 10001, Version.V_6_6_1),
        ...
        SEARCH_TIMEOUT_EXCEPTION(
            org.elasticsearch.search.SearchTimeoutException.class,
            org.elasticsearch.search.SearchTimeoutException::new,
            158,
            Version.V_7_6_0);
