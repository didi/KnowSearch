...
public final class IndexScopedSettings extends AbstractScopedSettings {
    ...
    public static final Set<Setting<?>> BUILT_IN_INDEX_SETTINGS = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(
        ...
        IndexSettings.INDEX_TRANSLOG_RETENTION_COMMIT_SIZE_SETTING,
        IndexSettings.INDEX_TRANSLOG_SUSPEND_SETTING,
        ...
        IndexModule.INDEX_QUERY_CACHE_TERM_QUERY_SETTING,
        IndexModule.INDEX_QUERY_CACHE_RING_SIZE_SETTING,
        ...
        IndexSettings.INDEX_CHECK_PENDING_FLUSH_ON_UPDATE,
        IndexSettings.INDEX_TRANSLOG_FSYNC_SETTING,
        IndexSettings.INDEX_ROUTING_RANDOM_SETTING,
        IndexSettings.INDEX_NUMBER_OF_ROUTING_SIZE_SETTING,
        IndexSettings.INDEX_MAPPING_SINGLE_TYPE_SETTING,
        IndexSettings.ON_HEAP_ID_TERMS_INDEX,
        IndexService.RETENTION_LEASE_SYNC_INTERVAL_SETTING,
        IndexSettings.INDEX_GLOBAL_SEARCH_TIMEOUT_SWITCH_SETTING,
