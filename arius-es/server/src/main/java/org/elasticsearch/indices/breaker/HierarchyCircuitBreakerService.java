...
public class HierarchyCircuitBreakerService extends CircuitBreakerService {
    ...
    private volatile BreakerSettings inFlightHttpRequestsSettings;
    ...
    public HierarchyCircuitBreakerService(Settings settings, ClusterSettings clusterSettings) {
        ...
        this.inFlightHttpRequestsSettings = new BreakerSettings(CircuitBreaker.IN_FLIGHT_HTTP_REQUESTS,
        ...
        registerBreaker(this.inFlightHttpRequestsSettings);
        ...
        clusterSettings.addSettingsUpdateConsumer(IN_FLIGHT_HTTP_REQUESTS_CIRCUIT_BREAKER_LIMIT_SETTING,
            IN_FLIGHT_HTTP_REQUESTS_CIRCUIT_BREAKER_OVERHEAD_SETTING, this::setInFlightHttpRequestsBreakerLimit);
    }
    ...
    private void setInFlightHttpRequestsBreakerLimit(ByteSizeValue newInFlightHttpRequestsMax, Double newInFlightHttpRequestsOverhead) {
        BreakerSettings newInFlightHttpRequestsSettings = new BreakerSettings(CircuitBreaker.IN_FLIGHT_HTTP_REQUESTS,
            newInFlightHttpRequestsMax.getBytes(), newInFlightHttpRequestsOverhead,
            HierarchyCircuitBreakerService.this.inFlightHttpRequestsSettings.getType(),
            this.inFlightRequestsSettings.getDurability());
        registerBreaker(newInFlightHttpRequestsSettings);
        HierarchyCircuitBreakerService.this.inFlightHttpRequestsSettings = newInFlightHttpRequestsSettings;
        logger.info("Updated breaker settings for in-flight requests: {}", newInFlightHttpRequestsSettings);
    }
