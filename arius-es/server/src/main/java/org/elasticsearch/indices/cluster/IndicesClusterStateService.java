...
public class IndicesClusterStateService extends AbstractLifecycleComponent implements ClusterStateApplier {
    ...
    private final List<IndexEventListener> buildInIndexListener = new CopyOnWriteArrayList<>();
    ...
    IndicesClusterStateService(
        ...
        this.buildInIndexListener.addAll(Arrays.asList(
            peerRecoverySourceService,
            recoveryTargetService,
            searchService,
            syncedFlushService,
    ...
    /**
     * Add a listener for index event states changes
     */
    public void addListener(IndexEventListener listener) {
        this.buildInIndexListener.add(listener);
    }
}
