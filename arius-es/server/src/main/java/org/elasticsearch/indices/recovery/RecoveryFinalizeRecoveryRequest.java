...
public final class RecoveryFinalizeRecoveryRequest extends TransportRequest {
    ...
    public RecoveryFinalizeRecoveryRequest(final long recoveryId, final ShardId shardId, final long globalCheckpoint, final long trimAboveSeqNo) {
