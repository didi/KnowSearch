...
public class IndexingSlowLogTests extends ESTestCase {
    ...
    public void testSlowLogMessageHasJsonFields() throws IOException {
        ...
        IndexingSlowLogMessage p = new IndexingSlowLogMessage(shardId, pd, 10, true, 0);
        ...
        p = new IndexingSlowLogMessage(shardId, pd, 10, true, Integer.MAX_VALUE);
    ...
    public void testSlowLogParsedDocumentPrinterSourceToLog() throws IOException {
        ...
        p = new IndexingSlowLogMessage(shardId, pd, 10, true, 3);
        assertThat(p.getFormattedMessage(), containsString("source[{\"f]"));

        // And you can truncate the source
        p = new IndexingSlowLogMessage(shardId, pd, 10, true, 3);
        assertThat(p.getFormattedMessage(), containsString("source[{\"f]"));
        assertThat(p.getFormattedMessage(), startsWith("[foo][0] took"));
        ...
        final UncheckedIOException e = expectThrows(UncheckedIOException.class,
            ()->new IndexingSlowLogMessage(shardId, doc, 10, true, 3));
