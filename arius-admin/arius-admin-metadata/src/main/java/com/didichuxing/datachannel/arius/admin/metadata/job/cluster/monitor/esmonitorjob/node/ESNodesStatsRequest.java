...
public class ESNodesStatsRequest extends BaseTimeoutRequest<ESNodesStatsRequest> {
    ...
    public final ESNodesStatsRequest nodesIds(String... nodesIds) {
        this.nodesIds = nodesIds;
        return this;
    }

    public ESNodesStatsRequest level(String level) {
        this.level = level;
        return this;
    }

    @SuppressWarnings("all")
    public ESNodesStatsRequest all() {
        flags.add(INDICES);
        flags.add(OS);
        flags.add(PROCESS);
        flags.add(JVM);
    ...
    public ESNodesStatsRequest clear() {
        flags.clear();
        return this;
    }


    public ESNodesStatsRequest flag(String name, boolean isSet) {
    ...
    public ESActionResponse toResponse(RestResponse response) throws Exception {
        ...
        ESNodesStatsResponse nodesStatsResponse = JSON.parseObject(obj.toJSONString(), ESNodesStatsResponse.class);
        if (null != nodes) {
