...
import com.didichuxing.datachannel.arius.elasticsearch.client.model.RestRequest;
import com.didichuxing.datachannel.arius.elasticsearch.client.model.RestResponse;
import com.didichuxing.datachannel.arius.elasticsearch.client.request.broadcast.ESBroadcastRequest;
...
public class ESIndicesSimpleStatsRequest extends ESBroadcastRequest<ESIndicesSimpleStatsRequest> {
    ...
    public static void main(String[] args) throws IOException {
        String respStr = new String(Files.readAllBytes(Paths.get("/Users/didi/result.txt")));
        stopWatch.start("normal反序列化");
        ESActionResponse esActionResponse = JSON.parseObject(respStr, ESIndicesStatsResponse.class);
        stopWatch.stop();

        stopWatch.start("simple反序列化");
        ESActionResponse esActionResponse2 = JSON.parseObject(respStr, ESIndicesSimpleStatsResponse.class);
        stopWatch.stop();
        System.out.println("反序列化耗时:" + stopWatch.toString());
    }*/
    ...
    public ESActionResponse toResponse(RestResponse response) throws Exception {
        ...
        // return JSON.parseObject(respStr, ESIndicesSimpleStatsResponse.class);
    }
