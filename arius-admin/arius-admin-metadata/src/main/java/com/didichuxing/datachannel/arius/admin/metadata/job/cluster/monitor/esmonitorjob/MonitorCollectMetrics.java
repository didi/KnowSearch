...
public class MonitorCollectMetrics {
    ...
    public static List<CollectMetrics> initIndexDataRegisterMap() {
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                ...
                .valueRoute(INDEXING_INDEX_TOTAL)
                .computeType(AVG).sendToN9e().build());

        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.indexing.index_time_in_millis_rate")
                .valueRoute(INDEXING_INDEX_TIME_IN_MILLIS)
                .computeType(AVG).build());

        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.indexing.index_time_in_millis")
                .valueRoute(INDEXING_INDEX_TIME_IN_MILLIS)
                .computeType(MINUS).sendToN9e().build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                ...
                .valueRoute(MERGES_TOTAL)
                .computeType(MINUS).build());

        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.merges.total_rate")
                .valueRoute(MERGES_TOTAL)
                .computeType(AVG).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.query_cache.memory_size_in_bytes")
                .valueRoute("query_cache.memory_size_in_bytes")
                .computeType(NONE).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.segments.points_memory_in_bytes")
                .valueRoute("segments.points_memory_in_bytes")
                .computeType(NONE).build());

        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.segments.doc_values_memory_in_bytes")
                .valueRoute("segments.doc_values_memory_in_bytes")
                .computeType(NONE).build());

        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.segments.index_writer_memory_in_bytes")
                .valueRoute("segments.index_writer_memory_in_bytes")
                .computeType(NONE).build());

        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.translog.size_in_bytes")
                .valueRoute("translog.size_in_bytes")
                .computeType(NONE).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.search.query_time_in_millis")
                .valueRoute(SEARCH_QUERY_TIME_IN_MILLIS)
                .computeType(MINUS).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.search.fetch_time_in_millis")
                .valueRoute(SEARCH_FETCH_TIME_IN_MILLIS)
                .computeType(MINUS).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.search.scroll_time_in_millis")
                .valueRoute(SEARCH_SCROLL_TIME_IN_MILLIS)
                .computeType(MINUS).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.refresh.total_rate")
                .valueRoute("refresh.total")
                .computeType(AVG).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.indices.flush.total_rate")
                .valueRoute("flush.total")
                .computeType(AVG).build());
        ...
        indexWorkOrders.add(new CollectMetrics.Builder()
                ...
                .valueRoute(STORE_SIZE_IN_BYTES)
                .computeType(NONE).build());
    ...
    public static List<CollectMetrics> initNodeDataRegisterMap() {
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.indexing.index_total")
                .valueRoute("indices.indexing.index_total")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.indexing.index_time_in_millis")
                .valueRoute("indices.indexing.index_time_in_millis")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.search.query_total")
                .valueRoute("indices.search.query_total")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.search.scroll_current")
                .valueRoute("indices.search.scroll_current")
                .computeType(NONE).build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.query_cache.memory_size_in_bytes")
                .valueRoute("indices.query_cache.memory_size_in_bytes")
                .computeType(NONE).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.request_cache.memory_size_in_bytes")
                .valueRoute("indices.request_cache.memory_size_in_bytes")
                .computeType(NONE).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.request_cache.hit_count")
                .valueRoute("indices.request_cache.hit_count")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.query_cache.hit_count")
                .valueRoute("indices.query_cache.hit_count")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.request_cache.miss_count")
                .valueRoute("indices.request_cache.miss_count")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.query_cache.miss_count")
                .valueRoute("indices.query_cache.miss_count")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.search.query_time_in_millis")
                .valueRoute("indices.search.query_time_in_millis")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.search.fetch_time_in_millis")
                .valueRoute("indices.search.fetch_time_in_millis")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.search.scroll_time_in_millis")
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                ...
                .computeType(NONE).sendToN9e().build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.segments.term_vectors_memory_in_bytes")
                .valueRoute("indices.segments.term_vectors_memory_in_bytes")
                .computeType(NONE).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.segments.points_memory_in_bytes")
                .valueRoute("indices.segments.points_memory_in_bytes")
                .computeType(NONE).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.segments.doc_values_memory_in_bytes")
                .valueRoute("indices.segments.doc_values_memory_in_bytes")
                .computeType(NONE).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.indices.segments.index_writer_memory_in_bytes")
                .valueRoute("indices.segments.index_writer_memory_in_bytes")
                .computeType(NONE).build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.http.current_open")
                .valueRoute("http.current_open")
                .computeType(NONE).build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.jvm.mem.heap_used_in_bytes")
                .valueRoute("jvm.mem.heap_used_in_bytes")
                .computeType(NONE).build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.jvm.gc.young.collection_time_in_millis")
                .valueRoute("jvm.gc.collectors.young.collection_time_in_millis")
                .computeType(MINUS).build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.jvm.gc.young.collection_count_rate")
                .valueRoute("jvm.gc.collectors.young.collection_count")
                .computeType(AVG).bIndexToNodeMetrics().build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.jvm.gc.old.collection_count_rate")
                .valueRoute("jvm.gc.collectors.old.collection_count")
                .computeType(AVG).bIndexToNodeMetrics().build());
        /**********************************node -> os*****************************************/

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.os.cpu.percent")
                .valueRoute("os.cpu.percent")
                .computeType(NONE).bIndexToNodeMetrics().sendToN9e().build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.os.cpu.load_average.1m")
                .valueRoute("os.cpu.load_average.1m")
                .computeType(NONE).bIndexToNodeMetrics().build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.os.cpu.load_average.5m")
                .valueRoute("os.cpu.load_average.5m")
                .computeType(NONE).bIndexToNodeMetrics().build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.os.cpu.load_average.15m")
                .valueRoute("os.cpu.load_average.15m")
                .computeType(NONE).bIndexToNodeMetrics().build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                ...
                .computeType(MINUS).bIndexToNodeMetrics().sendToN9e().build());
        ...
        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.thread_pool.write.rejected")
                .valueRoute("thread_pool.write.rejected")
                .computeType(MINUS).bIndexToNodeMetrics().sendToN9e().build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.thread_pool.write.completed")
                .valueRoute("thread_pool.write.completed")
                .computeType(MINUS).build());

        nodeWorkOrders.add(new CollectMetrics.Builder()
                .valueName("es.node.thread_pool.write.queue")
                .valueRoute("thread_pool.write.queue")
                .computeType(NONE).bIndexToNodeMetrics().sendToN9e().build());
