...
public class DataCentreUtil {
    ...
    public void init() {
        ...
        LOGGER.info("class=DataCentreUtil||method=init||ariusProjectIdTemplateAccess={}",
            getAriusProjectIdTemplateAccess());
    ...
    public String getAriusGatewayJoin() {
        return getIndexName(ariusGatewayJoin);
    }
    ...
    public String getAriusIndexSize() {
        return getIndexName(ariusIndexSize);
    }
    ...
    public String getAriusCatIndexInfo() {
        return getIndexName(ariusCatIndexInfo);
    }

    public String getAriusStatsClusterTaskInfo() {
        return getIndexName(ariusStatsClusterTaskInfo);
    }

    public String getAriusStatsDashBoardInfo() {
        return ariusStatsDashboardInfo;
    }
