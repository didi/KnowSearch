...
public class RequestPathThirdpart {
    ...
    public static final String LOGOUT = THIRDPART + "/sso/logout";
    public static final String REGISTER = THIRDPART + "/sso/register";
    public static final String PUBLIC_KEY = THIRDPART + "/sso/publicKey";
}
