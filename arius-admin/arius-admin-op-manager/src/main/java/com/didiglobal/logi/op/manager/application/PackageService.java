...
public class PackageService {
    private static final ILog LOGGER = LogFactory.getLog(PackageService.class);
    ...
    public List<PackageGroupConfig> listPackageGroupConfigByKey(String name, String version, Integer packageType) {
        return packageDomainService.listPackageGroupConfigByKey(name, version, packageType);
    }
}
