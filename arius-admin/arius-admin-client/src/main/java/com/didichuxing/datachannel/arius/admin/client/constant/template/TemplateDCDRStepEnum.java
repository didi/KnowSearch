...
public enum TemplateDCDRStepEnum {
                                  /**第一步：停止主索引写入*/
                                  STEP_1(1, "第一步：停止主索引写入%s"),

                                  STEP_2(2, "第二步：确保主从索引数据同步%s"),

                                  STEP_3(3, "第三步：删除源dcdr模板和索引链路%s"),

                                  STEP_4(4, "第四步：拷贝主模板的mapping信息到从模板%s"),

                                  STEP_5(5, "第五步：关闭从索引dcdr索引开关并打开主索引dcdr索引开关%s"),

                                  STEP_6(6, "第六步：停止从索引写入%s"),

                                  STEP_7(7, "第七步：创建新的dcdr链路%s"),

                                  STEP_8(8, "第八步：恢复主从索引实时写入%s"),

                                  STEP_9(9, "第九步：主从模板角色切换%s"),
