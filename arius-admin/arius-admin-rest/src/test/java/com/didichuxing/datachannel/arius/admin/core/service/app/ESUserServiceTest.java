...
class ESUserServiceTest extends AriusAdminApplicationTest {
    ...
    public void testDeleteByESUsers() {
        final Tuple<Result<Void>, List<ESUserPO>> resultListTuple = esUserService.deleteByESUsers(Mockito.anyInt());
        assertThat(resultListTuple.getV1()).isEqualTo(Result.<Void>buildSucc());
