...
class ProjectConfigServiceTest {
    ...
    void testUpdateOrInitProjectConfig() {
        ...
        assertThat(projectConfigService.updateOrInitProjectConfig(null, null).getV1().getMessage()).isEqualTo(
                Result.buildParamIllegal("配置信息为空").getMessage());
        projectConfigDTO.setProjectId(null);
        assertThat(
                projectConfigService.updateOrInitProjectConfig(projectConfigDTO, null).getV1().getMessage()).isEqualTo(
        ...
        assertThat(projectConfigService.updateOrInitProjectConfig(projectConfigDTO, null).getV1().success()).isTrue();
