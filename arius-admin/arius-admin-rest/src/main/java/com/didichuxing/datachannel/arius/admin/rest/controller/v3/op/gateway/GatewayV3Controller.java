...
public class GatewayV3Controller {
    ...
    @ApiOperation(value = "gateway 管理简要信息", tags = "0.3.2")
    ...
    @PostMapping("/join")
    @ApiOperation(value = "gateway 集群接入", tags = "0.3.2")
    ...
    @PostMapping("/page")
    @ResponseBody
    @ApiOperation(value = "按条件分页获取 gateway 集群集群列表",tags = "0.3.2")
    ...
    @ResponseBody
    @ApiOperation(value = "按条件分页获取 gateway 节点集群列表",tags = "0.3.2")
    ...
    @ResponseBody
    @ApiOperation(value = "按条件分页获取 gateway 配置列表",tags = "0.3.2")
    ...
    @ResponseBody
    @ApiOperation(value = "根据 gatewayClusterId 获取 gateway 集群信息",tags = "0.3.2")
    ...
    @ResponseBody
    @ApiOperation(value = "gateway 集群下线",tags = "0.3.2")
    ...
    @PutMapping("")
    @ResponseBody
    @ApiOperation(value = "gateway 编辑",tags = "0.3.2")
    ...
    @ResponseBody
    @ApiOperation(value = "获取 gateway 集群安装的插件列表",tags = "0.3.2")
    ...
    @ResponseBody
    @ApiOperation(value = "根据 configId 获取 gateway 配置信息",tags = "0.3.2")
