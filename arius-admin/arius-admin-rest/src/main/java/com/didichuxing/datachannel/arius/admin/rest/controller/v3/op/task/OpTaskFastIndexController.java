...
public class OpTaskFastIndexController {
    ...
    @ResponseBody
    @ApiOperation(value = "获取当前fastdump数据迁移支持的集群版本")
    ...
    @GetMapping("/es-clusters/installed/fast-dump")
    @ResponseBody
    @ApiOperation(value = "获取当前安装了fastdump且fastdump支持的集群")
    public Result<List<ClusterPhyVO>> ESClustersInstalledFastDump(HttpServletRequest request) {
