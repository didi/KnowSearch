...
public class NormalOrderController {
    ...
    public Result<List<OrderTypeVO>> getOrderTypes() {
        return ariusWorkOrderInfoManager.getOrderTypes();
    }
    ...
    public Result<AriusWorkOrderInfoSubmittedVO> submit(@PathVariable(value = "type") String type,
        ...
        return ariusWorkOrderInfoManager.submit( workOrderDTO );
    }
    ...
    public Result<Void> process(@PathVariable(value = "orderId") Long orderId, @RequestBody WorkOrderProcessDTO processDTO) {
        return ariusWorkOrderInfoManager.process(processDTO);
    }
    ...
    public Result<Void> cancelOrder(@PathVariable(value = "orderId") Long orderId) {
        return ariusWorkOrderInfoManager.cancelOrder(orderId, SpringTool.getUserName());
    }
    ...
    public Result<OrderDetailBaseVO> getOrderDetail(@PathVariable(value = "orderId") Long orderId) {
        return ariusWorkOrderInfoManager.getById(orderId);
    }

    @GetMapping("/orders")
    @ResponseBody
    @ApiOperation(value = "工单申请列表")
    public Result<List<AriusWorkOrderInfoVO>> getOrderApplyList(@RequestParam(value = "status") Integer status) {
        return ariusWorkOrderInfoManager.getOrderApplyList(SpringTool.getUserName(), status);
    }

    @GetMapping("/approvals")
    @ResponseBody
    @ApiOperation(value = "工单审核列表")
    public Result<List<AriusWorkOrderInfoVO>> getOrderApprovalList(@RequestParam(value = "status", required = false) Integer status) {
        return ariusWorkOrderInfoManager.getOrderApprovalListByStatus(status);
    }
}