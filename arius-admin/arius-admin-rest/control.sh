...
function start() {
    ...
    if [[ $cluster == "test" ]]; then
        ...
        nohup java -Xmx16g -Xms16g -Xmn4g -XX:MaxDirectMemorySize=4G -XX:MaxMetaspaceSize=256M -Djdk.nio.maxCachedBufferSize=262144 -jar $module.jar --spring.profiles.active=$env &
    fi
