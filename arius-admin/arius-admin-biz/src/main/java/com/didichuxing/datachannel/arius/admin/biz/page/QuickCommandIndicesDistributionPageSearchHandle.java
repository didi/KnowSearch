 ...
 */
@Component
public class QuickCommandIndicesDistributionPageSearchHandle extends
                                                             AbstractPageSearchHandle<IndexQueryDTO, IndicesDistributionVO> {
    ...
    protected PaginationResult<IndicesDistributionVO> buildPageData(IndexQueryDTO condition, Integer projectId) {
        try {
            ...
            List<IndicesDistributionVO> indexCatCellVOList = ConvertUtil
                .list2List(totalHitAndIndexCatCellListTuple.getV2(), IndicesDistributionVO.class);
