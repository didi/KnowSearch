...
@NoArgsConstructor
@AllArgsConstructor
public class ClusterOpOfflineNotify implements NotifyInfo {
    ...
    public String getTitle() {
        return NotifyConstant.ARIUS_MAIL_NOTIFY + "搜索平台集群下线申请成功";
    }
    ...
    private String getContent() {
        return String.format("您在Arius平台上使用APPID:%s, 对集群%s, 进行下线的工单申请已经审批通过！但还需进行集群下线的具体操作，后续具体进度可以咨询:%s", appId,
