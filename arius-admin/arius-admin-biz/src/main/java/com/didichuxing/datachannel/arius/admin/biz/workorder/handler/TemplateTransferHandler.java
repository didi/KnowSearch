...
public class TemplateTransferHandler extends BaseWorkOrderHandler {
    ...
    protected Result<Void> validateConsoleParam(WorkOrder workOrder) {
        ...
        if (AriusObjUtils.isNull(indexTemplateInfoService.getLogicTemplateById(content.getId()))) {
    ...
    protected Result<Void> doProcessAgree(WorkOrder workOrder, String approver) throws AdminOperateException {
        ...
        Result<Void> result = indexTemplateInfoService.turnOverLogicTemplate(content.getId(), content.getTgtAppId(),
