...
import com.didichuxing.datachannel.arius.admin.common.bean.entity.template.IndexTemplateInfoWithLabels;
...
public interface TemplateLogicManager {
     ...
     * @return list
     */
    List<IndexTemplateInfoWithLabels> getByLabelIds(String includeLabelIds, String excludeLabelIds);
     ...
     * @return label
     */
    IndexTemplateInfoWithLabels getLabelByLogicId(Integer logicId);
    ...
    Result<Integer> addTemplateWithoutCheck(IndexTemplateInfoDTO param, String operator) throws AdminOperateException;
    ...
    Result<Integer> createLogicTemplate(IndexTemplateInfoDTO param, String operator) throws AdminOperateException;
     ...
     * @return
     */
    List<IndexTemplateInfo> getTemplatesByAppIdAndAuthType(Integer appId, Integer authType);
