...
public interface OpTaskManager {
     ...
     */
    Result<List<WorkTaskVO>> addTaskESExpand(ESClusterExpandWithPluginDTO data, String operator,
        Integer projectId)
     ...
     * @return {@link Result}<{@link WorkTaskVO}>
     */
    Result<List<WorkTaskVO>> addTaskESShrink(ESClusterShrinkWithPluginDTO data, String operator, Integer projectId)
        throws NotFindSubclassException;
}