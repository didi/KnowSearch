...
@NoArgsConstructor
@AllArgsConstructor
public class LogicClusterIndecencyNotify implements NotifyInfo {
    ...
    private String getContent() {
        return String.format("您在Arius平台上使用APPID:%s, 申请集群%s, 扩缩容的需求已经被【%s】审批通过！", appId, logicClusterName, approver);
    }
}
