...
public interface ClusterNodeManager {
     ...
     * @return
     */
    List<ESRoleClusterHostVO> convertClusterLogicNodes(List<RoleClusterHostInfo> clusterNodes);
     ...
     * @return
     */
    List<ESRoleClusterHostVO> convertClusterPhyNodes(List<RoleClusterHostInfo> nodesInfo, String clusterPhyName);
}
