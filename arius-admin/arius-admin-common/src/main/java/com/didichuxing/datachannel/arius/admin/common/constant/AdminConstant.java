...
public class AdminConstant {
     ...
     * 版本为2.3.3版本的ES物理集群列表
     */
    public static final List<String> LOW_VERSION_ES_CLUSTER = Arrays.asList(
            "bigdata-arius-olap",
            "bigdata-arius-arcs",
            "mtn-to-es",
            "kefu-es",
    ...
    public static final String CLIENT_CLUSTER_HEALTH_CHECK_SUFFIX = DEFAULT_PHYSIC_CLUSTER_HTTP_SERVER_PORT + "/_cluster/health?pretty";
