...
public enum OperateRecordSortEnum {
    ...
    public static String getSortField(String sortTerm){
        ...
        return Arrays.stream(OperateRecordSortEnum.values())
                .filter(operateRecordSortEnum -> operateRecordSortEnum.getSortTerm().equals(sortTerm))
                .findFirst().map(OperateRecordSortEnum::getSortField).orElse( OPERATE_RECORD_ID.getSortField());
    }
