...
public enum OperateTypeEnum {
                             ...
                             */
                              ...
                              * 模板服务:模板扩缩容
                              */
                             TEMPLATE_SERVICE_CAPACITY(NewModuleEnum.TEMPLATE_SERVICE, "模板扩缩容",
                                                       31), TEMPLATE_SERVICE_EDIT_MAPPING(NewModuleEnum.TEMPLATE_SERVICE,
                                                                                          "编辑MAPPING",
                                                                                          60), TEMPLATE_SERVICE_EDIT_SETTING(NewModuleEnum.TEMPLATE_SERVICE,
                                                                                                                             "编辑SETTING",
                                                                                                                             59),
                             ...
                             INDEX_MANAGEMENT_ALIAS_MODIFY(NewModuleEnum.INDEX_MANAGEMENT, "别名调整",
                                                           36), INDEX_MANAGEMENT_LABEL_MODIFY(NewModuleEnum.INDEX_MANAGEMENT,
                                                                                              "标签调整", 56),
                             /**
                              * 索引管理:索引读写变更
                              */
                             ...
                             ES_CLUSTER_PLUGINS_ADD(NewModuleEnum.ES_CLUSTER_PLUGINS, "新增插件",
                                                    47), ES_CLUSTER_PLUGINS_EDIT(NewModuleEnum.ES_CLUSTER_PLUGINS,
                                                                                 "编辑插件",
                                                                                 48), ES_CLUSTER_PLUGINS_DELETE(NewModuleEnum.ES_CLUSTER_PLUGINS,
                                                                                                                "删除配置",
                                                                                                                49), ES_CLUSTER_CONFIG_DELETE(NewModuleEnum.ES_CLUSTER_CONFIG,
                                                                                                                                              "删除集群配置",
                                                                                                                                              50),

                             ES_CLUSTER_CONFIG_ADD(NewModuleEnum.ES_CLUSTER_CONFIG, "新增集群配置", 51),

                             ROLE_MANAGER_DELETE(NewModuleEnum.ROLE_MANAGER, "删除角色",
                                                 58), ROLE_MANAGER_CREATE(NewModuleEnum.ROLE_MANAGER, "创建角色",
                                                                          53), ROLE_MANAGER_UNBIND_USER(NewModuleEnum.ROLE_MANAGER,
                                                                                                        "角色解绑用户",
                                                                                                        54), ROLE_MANAGER_BIND_USER(NewModuleEnum.ROLE_MANAGER,
                                                                                                                                    "角色绑定用户",
                                                                                                                                    55);
