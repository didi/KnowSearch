...
public enum OpTaskTypeEnum {
    ...
    ES_CLUSTER_CONFIG_ROLLBACK(43, "ES集群配置回滚", "es-cluster-config-rollback"),
    ES_CLUSTER_OFFLINE(44, "ES集群下线操作", "es-cluster-offline"),
    ES_CLUSTER_PLUG_ROLLBACK(45, "ES集群插件回滚", "es-cluster-plugin-rollback"),
    ES_CLUSTER_PLUG_CONFIG(46, "ES集群插件配置变更", "es-cluster-plugin-config"),
    ES_CLUSTER_PLUG_CONFIG_ROLLBACK(47, "ES集群配置回滚", "es-cluster-plugin-config-rollback"),
    ES_PLUGIN_CLUSTER_EXPAND(48, "ES集群插件扩容", "es-cluster-plugin-expand"),
    
    ES_PLUGIN_CLUSTER_SHRINK(49, "ES集群插件缩容", "es-cluster-plugin-shrink"),
                            UNKNOWN(-1, "unknown");
    ...
    public static List<OpTaskTypeEnum> opManagerTask() {
        return Lists.newArrayList(GATEWAY_NEW, GATEWAY_CONFIG_EDIT, GATEWAY_EXPAND, GATEWAY_RESTART,
            ...
            ES_CLUSTER_PLUG_ROLLBACK,ES_CLUSTER_PLUG_CONFIG_ROLLBACK,ES_CLUSTER_PLUG_CONFIG,
            ES_PLUGIN_CLUSTER_EXPAND,ES_PLUGIN_CLUSTER_SHRINK);
    }
