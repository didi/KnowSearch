...
public enum OpTaskHandleEnum {
 ...
 ES_PLUGIN_CLUSTER_SHRINK(OpTaskTypeEnum.ES_PLUGIN_CLUSTER_SHRINK.getType(),
     OpTaskConstant.ES_PLUGIN_CLUSTER_SHRINK),
    ES_PLUGIN_CLUSTER_EXPAND(OpTaskTypeEnum.ES_PLUGIN_CLUSTER_EXPAND.getType(),
        OpTaskConstant.ES_PLUGIN_CLUSTER_EXPAND),
...
class OpTaskConstant {
    ...
    public static final String ES_PLUGIN_CLUSTER_SHRINK = "esPluginClusterShrinkTask";
    
    public static final String ES_PLUGIN_CLUSTER_EXPAND = "esPluginClusterExpandTask";
