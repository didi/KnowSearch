...
public enum DashBoardMetricTopTypeEnum {
    ...
    CLUSTER_ELAPSED_TIME(OneLevelTypeEnum.CLUSTER,"elapsedTime", "采集耗时"),
    ...
    NODE_ELAPSED_TIME(OneLevelTypeEnum.NODE,"elapsedTime", "采集耗时"),
    ...
    public static DashBoardMetricTopTypeEnum valueOfType(String type) {
        if (null == type) { return DashBoardMetricTopTypeEnum.UNKNOWN;}
    ...
    public static List<String> listNoNegativeMetricTypes() {
        return Lists.newArrayList(
                CLUSTER_GATEWAY_SUC_PER.getType(),
