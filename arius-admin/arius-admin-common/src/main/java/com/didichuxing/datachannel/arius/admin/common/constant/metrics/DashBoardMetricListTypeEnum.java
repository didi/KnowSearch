...
public enum DashBoardMetricListTypeEnum {
                                         UNKNOWN(OneLevelTypeEnum.UNKNOWN, "",
                                                 "未知"), CLUSTER_ELAPSED_TIME_GTE_5MIN(OneLevelTypeEnum.CLUSTER,
                                                                                      "elapsedTimeGte5Min",
                                                                                      "采集超过5分钟"), NODE_DEAD(OneLevelTypeEnum.NODE,
                                                                                                            "dead",
                                                                                                            "节点是否死亡"), NODE_LARGE_DISK_USAGE(OneLevelTypeEnum.NODE,
                                                                                                                                             "largeDiskUsage",
                                                                                                                                             "磁盘利用率是否超红线"), NODE_LARGE_HEAD(OneLevelTypeEnum.NODE,
                                                                                                                                                                            "largeHead",
                                                                                                                                                                            "堆内存利用率是否超红线"), NODE_LARGE_CPU_USAGE(OneLevelTypeEnum.NODE,
                                                                                                                                                                                                                 "largeCpuUsage",
                                                                                                                                                                                                                 "CPU利用率是否超红线"), NODE_WRITE_REJECTED_NUM(OneLevelTypeEnum.NODE,
                                                                                                                                                                                                                                                         "writeRejectedNum",
                                                                                                                                                                                                                                                         "WriteRejected节点"), NODE_SEARCH_REJECTED_NUM(OneLevelTypeEnum.NODE,
                                                                                                                                                                                                                                                                                                      "searchRejectedNum",
                                                                                                                                                                                                                                                                                                      "SearchRejected节点"), NODE_SHARD_NUM(OneLevelTypeEnum.NODE,
                                                                                                                                                                                                                                                                                                                                          "shardNum",
                                                                                                                                                                                                                                                                                                                                          "shardNum节点"),

                                         TEMPLATE_SEGMENT_MEM_NUM(OneLevelTypeEnum.TEMPLATE, "segmentMemSize",
                                                                  "模板Segments内存大小（MB）"), TEMPLATE_SEGMENT_NUM(OneLevelTypeEnum.TEMPLATE,
                                                                                                              "segmentNum",
                                                                                                              "模板Segments个数"),

                                         INDEX_RED(OneLevelTypeEnum.INDEX, "red",
                                                   "是否RED索引"), INDEX_SINGLE_REP(OneLevelTypeEnum.INDEX, "singReplicate",
                                                                                "是否单副本索引"), INDEX_UNASSIGNED_SHARD(OneLevelTypeEnum.INDEX,
                                                                                                                   "unassignedShard",
                                                                                                                   "是否是未分配shard索引"), INDEX_BIG_SHARD(OneLevelTypeEnum.INDEX,
                                                                                                                                                     "bigShard",
                                                                                                                                                     "大shard索引列表"), INDEX_SMALL_SHARD(OneLevelTypeEnum.INDEX,
                                                                                                                                                                                      "smallShard",
                                                                                                                                                                                      "小shard索引列表"), INDEX_MAPPING_NUM(OneLevelTypeEnum.INDEX,
                                                                                                                                                                                                                       "mappingNum",
                                                                                                                                                                                                                       "索引Mapping字段个数"), INDEX_SEGMENT_NUM(OneLevelTypeEnum.INDEX,
                                                                                                                                                                                                                                                           "segmentNum",
                                                                                                                                                                                                                                                           "索引Segments个数"), INDEX_SEGMENT_MEM_SIZE(OneLevelTypeEnum.INDEX,
                                                                                                                                                                                                                                                                                                   "segmentMemSize",
                                                                                                                                                                                                                                                                                                   "索引Segments内存大小（MB）");
