...
public enum DashBoardMetricListTypeEnum {
    ...
    public static DashBoardMetricListTypeEnum valueOfType(String type) {
        if (null == type) { return DashBoardMetricListTypeEnum.UNKNOWN;}
    ...
    public static List<String> getValueTypeList() {
        return Lists.newArrayList(
                NODE_WRITE_REJECTED_NUM.getType(),
                NODE_SEARCH_REJECTED_NUM.getType(),
                NODE_SHARD_NUM.getType(),
                NODE_LARGE_DISK_USAGE.getType(),
                NODE_LARGE_HEAD.getType(),
                NODE_LARGE_CPU_USAGE.getType(),
                TEMPLATE_SEGMENT_MEM_NUM.getType(),
                TEMPLATE_SEGMENT_NUM.getType(),
                INDEX_MAPPING_NUM.getType(),
                INDEX_SEGMENT_MEM_SIZE.getType(),
                INDEX_SEGMENT_NUM.getType());
    }
