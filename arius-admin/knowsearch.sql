...
(
    ...
    type        int(10)      default -1                not null comment 'appid的权限 1 读写 2 读 -1 未知',
    status      int(10)      default 1                 not null comment '状态 1有效 0无效',
    create_time timestamp    default CURRENT_TIMESTAMP not null comment '创建时间',
    update_time timestamp    default CURRENT_TIMESTAMP not null on update CURRENT_TIMESTAMP comment '更新时间'
)
    comment 'project模板信息' charset = utf8;
...
(
    ...
    comment 'appid逻辑集群权限' charset = utf8;
...
create index idx_project_id
    on project_arius_resource_logic (project_id);
...
(
    ...
    applicant        varchar(64)  default ''                not null comment '申请人',
    extensions       text                                   null comment '拓展字段',
    description      text                                   null comment '备注信息',
    approver         varchar(64)  default ''                not null comment '审批人',
