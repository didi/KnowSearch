...
INSERT INTO `metric_dictionary_info` VALUES (5233, '索引模板内存指标', 'Request Cache内存大小', '索引模板下索引所有Shard Request Cache(Cached Aggregation Results/...)堆内存汇总占用，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] 获取模板下所有的索引通过{indexName}/_stats?level=shards命令获取_all.total.request_cache.memory_size_in_bytes的总和', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-11-02 19:20:19', 1, 0, NULL, 'request_cache-memory_size_in_bytes');
...
INSERT INTO `metric_dictionary_info` VALUES (5058, '内存大小指标', 'Inflight http requests circuit breaker 内存占用', '统计当前http请求body占用内存总大小，与阀值比较，超过则熔断请求', '当前值', '[当前值] GET _nodes/stats命令获取breakers.in_flight_http_requests.limit_size_in_bytes[阈值]，breakers.in_flight_http_requests.estimated_size_in_bytes[当前值]', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Node', '2022-09-28 11:31:36', '2022-11-14 11:20:37', 1, 0, NULL, 'breakers-in_flight_http_requests-limit_size_in_bytes');
