...
INSERT INTO `metric_dictionary_info` VALUES (4933, '性能指标', '查询QPS', '集群Shard级别查询并发量概览', '60S', '[平均值] 集群下的所有节点，间隔时间内通过GET _nodes/stats命令获取nodes.{nodeName}.indices.search.query_total的差值累加值/间隔时间', 1, '次/S', '折线图', 0, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 11:06:07', 1, 0, NULL, 'readTps');
...
INSERT INTO `metric_dictionary_info` VALUES (4937, '性能指标', '查询耗时', '集群Shard级别查询耗时概览', '60S', '[平均值] 集群下的所有节点,间隔时间内通过GET _nodes/stats命令获取nodes.{nodeName}.indices.search.query_time_in_millis差值累加值/节点间隔时间内nodes.{nodeName}.indices.search.query_total差值累加值', 1, 'MS', '折线图', 0, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 11:06:08', 1, 0, NULL, 'searchLatency');
INSERT INTO `metric_dictionary_info` VALUES (4939, '性能指标', '写入耗时', '集群文档级别写入耗时概览', '60S', '[平均值] 集群下的所有节点,间隔时间内通过GET _nodes/stats命令获取nodes.{nodeName}.indices.indexing.index_time_in_millis差值累加值/节点间隔时间内nodes.{nodeName}.indices.docs.count差值累加值', 1, 'MS', '折线图', 0, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 11:06:08', 1, 0, NULL, 'indexingLatency');
...
INSERT INTO `metric_dictionary_info` VALUES (5153, '索引内存指标', 'Query Cache内存大小', '索引所有Shard Query Cache(Cached Filters/...)堆内存汇总占用，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] GET {indexName}_/statslevel=shards命令获取_all.total.query_cache.memory_size_in_bytes', 1, 'MB', '折线', 0, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-10-27 11:15:14', 1, 0, NULL, 'query_cache-memory_size_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5155, '索引内存指标', 'Stored Fields大小', '索引stored_fields_memory内存大小', '当前值', '[当前值] GET {indexName}_/statslevel=shards命令获取_all.total.segments.stored_fields_memory_in_bytes', 0, 'MB', NULL, 0, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-10-27 11:15:18', 1, 0, NULL, 'segments-stored_fields_memory_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5157, '索引内存指标', 'Norms内存大小', '索引所有Shard Norms(normalization factors for query time/text scoring)内存大小累加值，是底层Lucene内存汇总占用的一个子项，Top节点趋势', '当前值', '[当前值] GET {indexName}_/statslevel=shards命令获取_all.total.segments.norms_memory_in_bytes', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-10-27 11:15:22', 1, 0, NULL, 'segments-norms_memory_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5159, '索引内存指标', 'Version Map内存大小', '索引所有Shard Version Map(update/delete)内存大小累加值，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] GET {indexName}_/statslevel=shards命令获取_all.total.segments.version_map_memory_in_bytes', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-10-27 11:15:25', 1, 0, NULL, 'segments-version_map_memory_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5161, '索引内存指标', 'Fixed Bitsets内存大小', '索引所有Shard Fixed Bitsets(deeply nested object/...)内存大小累加值，是底层Lucene内存汇总占用的一个子项，Top节点趋势', '当前值', '[当前值] GET {indexName}_/statslevel=shards命令获取_all.total.segments.fixed_bit_set_memory_in_bytes', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-10-27 11:15:28', 1, 0, NULL, 'segments-fixed_bit_set_memory_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5163, '索引内存指标', 'Fielddata内存大小', '索引所有Shard Fielddata(global ordinals /enable fielddata on text field/...)内存汇总占用，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] GET {indexName}_/statslevel=shards命令获取_all.total.fielddata.memory_size_in_bytes', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-10-27 11:15:32', 1, 0, NULL, 'fielddata-memory_size_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5165, '索引内存指标', 'Request Cache内存大小', '索引所有Shard Request Cache(Cached Aggregation Results/...)堆内存汇总占用，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] GET {indexName}_/statslevel=shards命令获取_all.total.segments.request_cache.memory_size_in_bytes', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-10-27 11:15:38', 1, 0, NULL, 'segments-request_cache-memory_size_in_bytes');
...
INSERT INTO `metric_dictionary_info` VALUES (5175, '索引模板性能指标', '写入耗时', '索引模板写入耗时平均值，Top节点趋势', '60S', '[平均值] (间隔时间内通过{indexName}/_stats?level=shards命令获取_all.total.indexing.index_time_in_millis的差值)/ 间隔时间内_all.total.docs.count的差值', 1, 'MS', '折线', 1, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-10-28 14:27:40', 1, 0, NULL, 'indices-indexing-index_time_per_doc');
...
INSERT INTO `metric_dictionary_info` VALUES (5225, '索引模板内存指标', 'Norms内存大小', '索引模板下索引所有Shard Norms(normalization factors for query time/text scoring)内存大小累加值，是底层Lucene内存汇总占用的一个子项，Top节点趋势', '当前值', '[当前值] 获取模板下所有的索引通过{indexName}/_stats?level=shards命令获取segments-norms_memory_in_bytes的总和', 0, 'MB', '折线图', 0, NULL, NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:12', 1, 0, NULL, 'segments-norms_memory_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5227, '索引模板内存指标', 'Version Map内存大小', '索引模板下索引所有Shard Version Map(update/delete)内存大小累加值，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] 获取模板下所有的索引通过{indexName}/_stats?level=shards命令获取segments-version_map_memory_in_bytes的总和', 0, 'MB', '折线图', 0, NULL, NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:12', 1, 0, NULL, 'segments-version_map_memory_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5229, '索引模板内存指标', 'Fixed Bitsets内存大小', '索引模板下索引所有Shard Fixed Bitsets(deeply nested object/...)内存大小累加值，是底层Lucene内存汇总占用的一个子项，Top节点趋势', '当前值', '[当前值] 获取模板下所有的索引通过{indexName}/_stats?level=shards命令获取fixed_bit_set_memory_in_bytes的总和', 0, 'MB', '折线图', 0, NULL, NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:12', 1, 0, NULL, 'segments-fixed_bit_set_memory_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5231, '索引模板内存指标', 'Fielddata内存大小', '索引模板下索引所有Shard Fielddata(global ordinals /enable fielddata on text field/...)内存汇总占用，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] 获取模板下所有的索引通过{indexName}/_stats?level=shards命令获取fielddata.memory_size_in_bytes的总和', 0, 'MB', '折线图', 0, NULL, NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:12', 1, 0, NULL, 'fielddata-memory_size_in_bytes');
INSERT INTO `metric_dictionary_info` VALUES (5233, '索引模板内存指标', 'Request Cache内存大小', '索引模板下索引所有Shard Request Cache(Cached Aggregation Results/...)堆内存汇总占用，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] 获取模板下所有的索引通过{indexName}/_stats?level=shards命令获取request_cache.memory_size_in_bytes的总和', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:12', 1, 0, NULL, 'segments-request_cache-memory_size_in_bytes');
...
INSERT INTO `metric_dictionary_info` VALUES (5241, '集群', '写入耗时', '索引写入性能对比分析，性能不足集群预警', '5*60S', '[平均值] 集群下的所有节点,间隔时间内通过GET _nodes/stats命令获取nodes.{nodeName}.indices.indexing.index_time_in_millis差值累加值/节点间隔时间内nodes.{nodeName}.indices.docs.count差值累加值', 0, 'S', '折线图，可选Top5-Top50', 0, 'ES引擎', NULL, 'Dashboard', '2022-09-28 11:31:36', '2022-10-09 19:32:27', 1, 0, NULL, 'indexingLatency');
...
INSERT INTO `metric_dictionary_info` VALUES (5249, '集群', '查询耗时', '索引查询性能对比分析，查询性能不足集群预警', '5*60S', '[平均值] 集群下的所有节点,间隔时间内通过GET _nodes/stats命令获取nodes.{nodeName}.indices.search.query_time_in_millis差值累加值/节点间隔时间内nodes.{nodeName}.indices.search.query_total差值累加值', 0, 'S', '折线图，可选Top5-Top50', 0, 'ES引擎', NULL, 'Dashboard', '2022-09-28 11:31:36', '2022-10-09 19:32:45', 1, 0, NULL, 'searchLatency');
