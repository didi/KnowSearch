...
INSERT INTO `metric_dictionary_info` VALUES (4917, '系统指标', 'CPU使用率（平均分位值、99分位值、95分位值、75分位值、55分位值）', '集群CPU使用率与均衡情况观察', '当前值', '[当前值] 集群下所有节点，通过_noder/stats命令获取nodes.{nodeName}.os.cpu.percent ，根据分位进行聚合', 1, '%', '折线图', 1, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 09:20:09', 1, 0, NULL, 'cpuUsage');
INSERT INTO `metric_dictionary_info` VALUES (4919, '系统指标', 'CPU 1分钟负载（平均分位值、99分位值、95分位值、75分位值、55分位值）', '集群1分钟负载与均衡情况观察', '当前值', '[当前值] 集群下所有节点，通过_noder/stats命令获取nodes.{nodeName}.os.cpu.load_average.1m，根据分位进行聚合', 0, NULL, '折线图', 0, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 11:06:05', 1, 0, NULL, 'cpuLoad1M');
...
INSERT INTO `metric_dictionary_info` VALUES (4925, '系统指标', '网络出口流量', '集群网络出口流量/网络入口流量走势', '当前值', '[当前值] 集群下的所有节点，通过_node/stats命令获取nodes.{nodeName}.transport.rx_size_in_bytes_rate、nodes.{nodeName}.transport.tx_size_in_bytes_rate（接收、发送）的累加值', 0, 'MB/S', '折线图', 0, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 11:06:06', 1, 0, NULL, 'sendTransSize');
...
INSERT INTO `metric_dictionary_info` VALUES (4932, '系统指标', '网络入口流量', '集群网络出口流量/网络入口流量走势', '当前值', '[当前值] 集群下的所有节点，通过_node/stats命令获取nodes.{nodeName}.transport.rx_size_in_bytes_rate、nodes.{nodeName}.transport.tx_size_in_bytes_rate（接收、发送）的累加值', 0, 'MB/S', '折线图', 0, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 11:06:07', 1, 0, NULL, 'recvTransSize');
...
INSERT INTO `metric_dictionary_info` VALUES (4935, '性能指标', '写入TPS', '集群Shard级别写入并发量概览', '60S', '[平均值] 集群下的所有节点，间隔时间内通过_node/stats命令获取nodes.{nodeName}.indices.indexing.index_total的差值累加值/间隔时间', 1, '个/S', '折线图', 0, 'ES引擎', NULL, 'OverView', '2022-09-28 11:31:36', '2022-09-29 11:06:07', 1, 0, NULL, 'writeTps');
...
INSERT INTO `metric_dictionary_info` VALUES (4967, '系统指标', '网络发送流量', '网络包为单位的每秒发送流量，Top节点趋势', '当前值', '[当前值] _nodes/stats命令获取nodes.{nodeName}.transport.tx_size_in_bytes', 0, 'MB/S', '折线图', 1, 'ES引擎', NULL, 'Node', '2022-09-28 11:31:36', '2022-09-30 10:36:18', 1, 0, NULL, 'transport-tx_size_in_bytes_rate');
INSERT INTO `metric_dictionary_info` VALUES (4969, '系统指标', '网络接收流量', '网络包为单位的接收流量，Top节点趋势', '当前值', '[当前值] _nodes/stats命令获取nodes.{nodeName}.transport.rx_size_in_bytes', 0, 'MB/S', '折线图', 0, 'ES引擎', NULL, 'Node', '2022-09-28 11:31:36', '2022-09-30 10:36:28', 1, 0, NULL, 'transport-rx_size_in_bytes_rate');
...
INSERT INTO `metric_dictionary_info` VALUES (5000, '基本性能指标', 'request Cache eviction', '节点Request Cache缓存驱逐数，Top节点趋势', '当前值', '[差值] 间隔时间内通过_nodes/stats命令获取nodes.{nodeName}.indices.request_cache.evictions的差值/时间间隔(MIN)', 0, '次/MIN', '折线图', 0, 'ES引擎', NULL, 'Node', '2022-09-28 11:31:36', '2022-10-11 11:23:37', 1, 0, NULL, 'indices-request_cache-evictions');
...
INSERT INTO `metric_dictionary_info` VALUES (5055, '内存大小指标', 'Fielddata内存大小', '节点所有Shard的Fielddata(global ordinals /enable fielddata on text field/...)内存汇总占用，不在Lucene内存占用统计范围内，Top节点趋势', '当前值', '[当前值] _nodes/stats命令获取indices.segments.breakers.fielddata.limit_size_in_bytes', 0, 'MB', '折线图', 0, 'ES引擎', NULL, 'Node', '2022-09-28 11:31:36', '2022-10-10 10:55:25', 1, 0, NULL, 'indices-segments-breakers-fielddata-limit_size_in_bytes');
...
INSERT INTO `metric_dictionary_info` VALUES (5090, '基本性能指标', 'query Cache evictions', '节点Query Cache缓存驱逐数，Top节点趋势', '当前值', '[差值] 间隔时间内通过_nodes/stats命令获取nodes.{nodeName}.indices.query_cache.evictions的差值/时间间隔(MIN)', 0, '次/MIN', '折线图', 0, 'ES引擎', NULL, 'Node', '2022-09-28 11:31:36', '2022-10-11 11:23:37', 1, 0, NULL, 'indices-query_cache-evictions');
...
INSERT INTO `metric_dictionary_info` VALUES (5107, '索引性能指标', '写入耗时', '索引写入耗时平均值，Top节点趋势', '60S', '[平均值] ( 间隔时间内通过{indexName}/stats?level=shards命令获取_all.total.indexing.index_time_in_millis的差值)/ 间隔时间内_all.total.docs.count的差值', 1, 'MS', '折线', 1, 'ES引擎', NULL, 'Index', '2022-09-28 11:31:36', '2022-09-29 09:23:53', 1, 0, NULL, 'indexing-index_time_in_millis');
...
INSERT INTO `metric_dictionary_info` VALUES (5173, '索引模板性能指标', '写入TPS', '索引模板写入速率平均值，Top节点趋势', '60S', '[平均值] 间隔时间内模板下所有的索引通过{indexName}/stats?level=shards命令获取 _all.primaries.search.query_total的差值累加值间隔时间', 1, '个/S', '折线', 1, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 09:38:14', 1, 0, NULL, 'indexing-index_total_rate');
INSERT INTO `metric_dictionary_info` VALUES (5175, '索引模板性能指标', '写入耗时', '索引模板写入耗时平均值，Top节点趋势', '60S', '[平均值] 获取 间隔时间内模板下所有的索引通过{indexName}/stats?level=shards命令获取_all.primaries..search-query_time_in_millis的差值再累加值/间隔时间', 1, 'MS', '折线', 1, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 09:38:16', 1, 0, NULL, 'indexing-index_time_in_millis');
INSERT INTO `metric_dictionary_info` VALUES (5177, '索引模板性能指标', '查询Query QPS', '索引模板Query速率平均值，Top节点趋势', '60S', '[平均值] 获取模板下所有的索引通过{indexName}/stats?level=shards命令获取 间隔时间内_all.primaries.search.query_total的差值/间隔时间', 1, '次/S', '折线', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:05', 1, 0, NULL, 'search-query_total_rate');
...
INSERT INTO `metric_dictionary_info` VALUES (5187, '索引模板性能指标', '查询Fetch QPS', '索引模板Fetch速率平均值，Top节点趋势', '60S', '[平均值] 获取模板下所有的索引通过{indexName}/stats?level=shards命令获取_all.total.search.fetch_total的差值/时间间隔', 0, '次/S', '折线', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:07', 1, 0, NULL, 'search-fetch_total_rate');
INSERT INTO `metric_dictionary_info` VALUES (5189, '索引模板性能指标', '查询Query耗时', '索引模板Query耗时平均值，Top节点趋势', '60S', '[平均值] 间隔时间内获取模板下所有的索引通过{indexName}/stats?level=shards命令_all.total.search.query_time_in_millis的差值累加值', 0, 'MS', '折线', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:07', 1, 0, NULL, 'cost-query_time_in_millis');
INSERT INTO `metric_dictionary_info` VALUES (5191, '索引模板性能指标', '查询Fetch耗时', '索引模板Fetch耗时平均值，Top节点趋势', '60S', '[平均值] 获取 间隔时间内模板下所有的索引通过{indexName}/stats?level=shards命令获取_all.total.search.fetch_time_in_millis的差值累加值/ 间隔时间内_all.total.search.fetch_total的差值累加值', 0, 'MS', '折线', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:08', 1, 0, NULL, 'cost-fetch_time_in_millis');
INSERT INTO `metric_dictionary_info` VALUES (5193, '索引模板性能指标', '查询Scroll量', '索引模板下索引Shard 级别 Scroll请求量，Top节点趋势', '60S', '[平均值] 获取间隔时间内模板下所有的索引通过{indexName}/stats?level=shards命令获取_all.total.search.scroll_total的差值累加值', 0, '个', '折线', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:08', 1, 0, NULL, 'search-scroll_total_rate');
...
INSERT INTO `metric_dictionary_info` VALUES (5203, '索引模板性能指标', 'Merge次数', '索引模板Merge次数，Top节点趋势', '60S', '[平均值] 获取模板下所有的索引通过{indexName}/stats?level=shards命令获取_all.total.merges-total的差值累加值/时间间隔', 0, '次/MIN', '折线', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:09', 1, 0, NULL, 'merges-total_rate');
INSERT INTO `metric_dictionary_info` VALUES (5205, '索引模板性能指标', 'Refresh次数', '索引模板Refresh次数，Top节点趋势', '60S', '[平均值] 获取模板下所有的索引通过{indexName}/stats?level=shards命令获取_all.total.refresh-total_rate的累加值差值/时间间隔', 0, '次/MIN', '折线', 0, 'ES引擎', NULL, 'Index_template', '2022-09-28 11:31:36', '2022-09-29 11:06:10', 1, 0, NULL, 'refresh-total_rate');
