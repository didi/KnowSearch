...
(
    ...
    `app_name`        varchar(100)  NOT NULL DEFAULT '' COMMENT ' 被调度的应用名称 ',
    `node_name_white_list_str` varchar(3000) NOT NULL DEFAULT '' COMMENT '执行节点名对应白名单集',
    `create_time`     datetime               DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `update_time`     datetime               DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`),
...
(
    ...
    `create_time`     datetime              DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `update_time`     datetime              DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    `node_name`       varchar(100) NOT NULL DEFAULT '' COMMENT 'node 名',
    PRIMARY KEY (`id`),
...
#0.3.2新增权限点
INSERT INTO `kf_security_permission` (`id`, `permission_name`, `parent_id`, `leaf`, `level`, `description`, `create_time`, `update_time`, `is_delete`, `app_name`) VALUES (1883,'脚本中心', 0, 0, 1, '脚本中心', '2022-12-21 15:08:22', '2022-12-21 15:10:32', 0, 'know_search');
...
INSERT INTO `kf_security_permission` (`id`, `permission_name`, `parent_id`, `leaf`, `level`, `description`, `create_time`, `update_time`, `is_delete`, `app_name`) VALUES (1917,'查看脚本中心列表', 1883, 1, 2, '查看脚本中心列表', '2022-12-21 15:08:22', '2022-12-21 15:10:32', 0, 'know_search');
INSERT INTO `kf_security_permission` (`id`, `permission_name`, `parent_id`, `leaf`, `level`, `description`, `create_time`, `update_time`, `is_delete`, `app_name`) VALUES (1919,'新建脚本', 1883, 1, 2, '新建脚本', '2022-12-21 15:08:22', '2022-12-21 15:10:32', 0, 'know_search');
INSERT INTO `kf_security_permission` (`id`, `permission_name`, `parent_id`, `leaf`, `level`, `description`, `create_time`, `update_time`, `is_delete`, `app_name`) VALUES (1921,'编辑', 1883, 1, 2, '编辑', '2022-12-21 15:08:22', '2022-12-21 15:10:32', 0, 'know_search');
INSERT INTO `kf_security_permission` (`id`, `permission_name`, `parent_id`, `leaf`, `level`, `description`, `create_time`, `update_time`, `is_delete`, `app_name`) VALUES (1923,'删除', 1883, 1, 2, '删除', '2022-12-21 15:08:22', '2022-12-21 15:10:32', 0, 'know_search');
