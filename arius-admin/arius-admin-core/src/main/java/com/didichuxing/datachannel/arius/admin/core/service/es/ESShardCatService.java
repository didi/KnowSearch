...
public interface ESShardCatService {
    ...
    Tuple<Long, List<ShardDistributionVO>> syncGetCatShardInfo(String queryCluster, String index, Integer queryProjectId, long from, Long size, String sortTerm, Boolean orderByDesc);
