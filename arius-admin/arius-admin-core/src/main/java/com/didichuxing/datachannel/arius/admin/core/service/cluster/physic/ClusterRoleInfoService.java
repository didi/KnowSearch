 ...
 * @date 2022/5/9
 */
public interface ClusterRoleInfoService {

    /**
     * 保存集群角色
     * @param esClusterRoleInfoDTO
     * @return id
     */
    Result<Void> save(ESClusterRoleInfoDTO esClusterRoleInfoDTO);
     ...
     */
    ClusterRoleInfo getById(Long id);
