...
public class GatewayClusterServiceImpl implements GatewayClusterService {
	...
	public boolean deleteOneById(Integer gatewayClusterId) {
			final GatewayClusterPO oneById = gatewayClusterDAO.getOneById(gatewayClusterId);
	...
	@Override
	public List<GatewayClusterPO> listByNames(List<String> gatewayClusterName) {
		return gatewayClusterDAO.listByNames(gatewayClusterName);
	}
