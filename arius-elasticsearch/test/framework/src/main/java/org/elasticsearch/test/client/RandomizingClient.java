...
public class RandomizingClient extends FilterClient {
    ...
    public SearchRequestBuilder prepareSearch(String... indices) {
        ...
        logger.info("prepareSearch info : indices -> {}, defaultSearchType -> {}, defaultPreference -> [{}], batchedReduceSize -> {}, maxConcurrentShardRequests -> {}, preFilterShardSize -> {}, doTimeout -> {}",
            indices, defaultSearchType, defaultPreference, batchedReduceSize, maxConcurrentShardRequests, preFilterShardSize, doTimeout);
