...
public interface ClusterApplier {
    ...
    interface RichClusterApplyListener extends ClusterApplyListener {
        /**
         * Called on successful cluster state application
         *
         * @param source    information where the cluster state came from
         * @param taskState task execution time
         */
        default void onSuccess(String source, TaskState taskState) {
        }
         ...
         * @param e         exception that occurred
         */
        default void onFailure(String source, TaskState taskState, Exception e) {
        }
    }
}
