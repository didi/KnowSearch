...
public class IndexMetaData implements Diffable<IndexMetaData>, ToXContentFragment {
    ...
    public static final String INDEX_SETTING_REGION_ATTRIBUTE = "region";
    public static final String INDEX_SETTING_DEFAULT_REGION_NAME = "default";
    ...
    public boolean isRoutingSize() {
        return settings.getAsInt(IndexSettings.INDEX_NUMBER_OF_ROUTING_SIZE, -1) != -1;
    }

    public int getNumberOfRoutingSize() {
        return settings.getAsInt(IndexSettings.INDEX_NUMBER_OF_ROUTING_SIZE, numberOfShards);
    }
