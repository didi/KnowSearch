...
public final class IndexModule {
    ...
    public static final Setting<Integer> INDEX_QUERY_CACHE_RING_SIZE_SETTING =
        Setting.intSetting("index.queries.cache.ringSize", 256, Property.IndexScope, Property.Dynamic);
    ...
    public IndexService newIndexService(
        ...
        try {
            ...
            final IndexService indexService = new IndexService(indicesService, indexSettings, indexCreationContext, environment, xContentRegistry,
