...
public final class SingleFieldsVisitor extends StoredFieldVisitor {
    ...
    public Status needsField(FieldInfo fieldInfo) {
        ...
        if (fieldInfo.name.equals(UidFieldMapper.NAME)) {
            if (TypeFieldMapper.NAME.equals(field.name()) || IdFieldMapper.NAME.equals(field.name())) {
                return Status.YES;
            }
        }
        return Status.NO;
    ...
    public void stringField(FieldInfo fieldInfo, byte[] bytes) {
        ...
        if (UidFieldMapper.NAME.equals(fieldInfo.name) && field.name().equals(IdFieldMapper.NAME)) {
