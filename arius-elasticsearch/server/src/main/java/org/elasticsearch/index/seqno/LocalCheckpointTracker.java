...
public class LocalCheckpointTracker {
    ...
    /* for append lucene */
    public synchronized void setCheckpointForAppendLucene(final long docsCount) {
        nextSeqNo.addAndGet(docsCount);
        processedSeqNo.clear();
        persistedSeqNo.clear();
        long curMaxSeqNo = getMaxSeqNo();
        persistedCheckpoint.set(curMaxSeqNo);
        processedCheckpoint.set(curMaxSeqNo);
    }
