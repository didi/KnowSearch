...
public class IndicesModuleTests extends ESTestCase {
    ...
    private static String[] EXPECTED_METADATA_FIELDS = new String[]{IgnoredFieldMapper.NAME, UidFieldMapper.NAME, IdFieldMapper.NAME,
    ...
    private static String[] EXPECTED_METADATA_FIELDS_6x = new String[]{AllFieldMapper.NAME, IgnoredFieldMapper.NAME, UidFieldMapper.NAME,
