...
public class CreateReplicationAction extends
    ...
    public static final CreateReplicationAction INSTANCE = new CreateReplicationAction();
    public static final String NAME = "indices:admin/dcdr/create_replication";

    private CreateReplicationAction() {
    ...
    public static class Request extends AcknowledgedRequest<Request> implements IndicesRequest, ToXContentObject {
        ...
        public static Request fromXContent(final XContentParser parser, final String primaryIndex) throws IOException {
