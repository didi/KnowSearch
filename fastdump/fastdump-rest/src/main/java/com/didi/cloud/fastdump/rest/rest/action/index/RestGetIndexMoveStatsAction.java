 ...
 */
@Component
public class RestGetIndexMoveStatsAction extends BaseCommonHttpAction {
    private final GetIndexMoveStatsAction getIndexMoveStatsAction;

    public RestGetIndexMoveStatsAction(GetIndexMoveStatsAction getIndexMoveStatsAction) {
        this.getIndexMoveStatsAction = getIndexMoveStatsAction;
    }

    @Override
    protected void register() {
        restHandlerFactory.registerHandler(GET, "index-move/{taskId}/stats", this);
    }
    ...
    protected void handleRequest(QueryContext queryContext, RestChannel channel) throws Exception {
        ...
        sendResponse(channel, Result.build(true, indexMoveTaskStats));
    }
}
