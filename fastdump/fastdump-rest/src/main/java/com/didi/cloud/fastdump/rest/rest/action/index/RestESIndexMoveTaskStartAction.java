...
import com.didi.cloud.fastdump.core.action.movetask.ESIndexMoveTaskStartAction;
 ...
 */
@Component
public class RestESIndexMoveTaskStartAction extends BaseCommonHttpAction {
    @Autowired
    private ESIndexMoveTaskStartAction esIndexMoveTaskStartAction;
    @Override
    protected void register() {
        restHandlerFactory.registerHandler( RestRequest.Method.POST, "/index-move/start", this);
    }

    @Override
    protected String name() { return "index-move-start";}
    ...
    protected void handleRequest(QueryContext queryContext, RestChannel channel) throws Exception {
        ...
        esIndexMoveTaskStartAction.doAction(esIndexMoveTaskActionContext);
